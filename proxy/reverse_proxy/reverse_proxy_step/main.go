...
var addr = "127.0.0.1:2022"

func main() {
	//127.0.0.1:2022/xxx
	//127.0.0.1:2023/base/xxx
	url, err1 := url.Parse("http://127.0.0.1:2023/base")
	if err1 != nil {
		log.Println(err1)
	}
...
func NewSingleHostReverseProxy(target *url.URL) *httputil.ReverseProxy {
	//http://127.0.0.1:2022/dir?name=123
	//RayQuery: name=123
	//Scheme: http
	//Host: 127.0.0.1:2022
	...
	director := func(req *http.Request) {
		//url_rewrite
		//127.0.0.1:2022/dir/abc ==> 127.0.0.1:2023/base/abc ??
		//127.0.0.1:2022/dir/abc ==> 127.0.0.1:2022/abc
		//127.0.0.1:2022/abc ==> 127.0.0.1:2023/base/abc
